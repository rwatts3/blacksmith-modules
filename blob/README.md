# Blob storages with Blacksmith

Module `blob` offers a Go API to Load data from a Blacksmith application to
different blob storages, with support for AWS S3, Azure Blob Storage, Google
Cloud Storage.
