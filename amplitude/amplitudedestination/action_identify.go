...
func (a Identify) Marshal(tk *destination.Toolkit) (*destination.Job, error) {
	...
	// Set the humanized event name for the "identify" event. Also, create a
	// unique insert identifier to ensure data is not duplicated in Amplitude
	// in case of a 500, 502, or 504 HTTP error.
	insertId := ksuid.New().String()
	for i := range a.Events {
		a.Events[i].Event = "Identify"
